...
% Customize algorithm appearance (define length if algorithm package not loaded)
\newlength{\algorithmicindent}
\setlength{\algorithmicindent}{9pt}
...
% NeurIPS 2025 track name fallback (avoids undefined \\@trackname)
\makeatletter
